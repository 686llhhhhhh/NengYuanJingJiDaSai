# -*- coding: utf-8 -*-
"""
Created on Tue Mar 22 22:42:43 2022
...
def write(xxx):
    features2 = ['水解pH_change', '水解VFA_change', '水解TS', '水解VS', '水解氨氮_change', 
                '水解COD_change', '发酵pH_change', '发酵VFA_change', '发酵碱度_change', 
                '发酵TS', '发酵VS','发酵氨氮_change', '发酵COD_change', '进料量', ]
    ...
    f = ['时间', '水解pH', '水解pH_change', '水解VFA', '水解VFA_change', '水解TS', 
         '水解VS', '水解氨氮', '水解氨氮_change', '水解COD', '水解COD_change', 
         '发酵pH', '发酵pH_change', '发酵VFA', '发酵VFA_change', '发酵碱度', '发酵碱度_change', 
         '发酵TS', '发酵VS', '发酵氨氮', '发酵氨氮_change', '发酵COD', '发酵COD_change', 
         '进料量', '产气量', '产气量_change', '产气量_提升', '单位VS产气量', '单位VS产甲烷量_change',]
    xxx = xxx.loc[:,f]
...
def tiao(b, pd, trans_x, trans_y):
    features = ['水解pH', '水解VFA', '水解TS', '水解VS', '水解氨氮', '水解COD', 
                '发酵pH', '发酵VFA', '发酵碱度', '发酵TS', '发酵VS','发酵氨氮', 
                '发酵COD', '进料量', ]
    for w in shuxing:
        b[w] = pd[w]
    xx = b.loc[:,features]
    ...
    features = ['水解pH', '水解VFA', '水解氨氮', '水解COD', 
                '发酵pH', '发酵VFA', '发酵碱度', '发酵氨氮', '发酵COD',]
...
if __name__ == '__main__':
    ...
    file = r'D:\本科\任务\沼气工程\0315\能源经济大赛\dta厌氧工厂'
    ...
    shuxing = ['水解TS', '水解VS', '发酵TS', '发酵VS', '进料量']
